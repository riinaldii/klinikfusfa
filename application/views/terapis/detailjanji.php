                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="active tab-pane" id="profile">
                            <?= form_open_multipart('terapis/detailjanji'); ?>
                            <div class="modal-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" name="catatan" id="catatan" value="<?= $janjitemu['catatan']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div>
                            ...
                            <div class="col-sm-10">
                                <a href="<?= base_url('terapis/index'); ?>" class="btn btn-primary">Kembali</a>
                            </div>
                            </form>
