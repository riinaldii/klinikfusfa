...
<head>
  ...
  <link href="<?= base_url('assets/'); ?>bower_components/fontawesome/css/all.min.css" rel="stylesheet" type="text/css">
...
<body id="page-top">
  ...
  <script src="<?= base_url('assets/'); ?>bower_components/bootstrap/js/bootstrap.bundle.min.js"></script>
